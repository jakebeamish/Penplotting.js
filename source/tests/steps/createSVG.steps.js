...
defineFeature(feature, test => {
  ...
  test('Create an SVG with specific dimensions', ({ given, when, then }) => {
    ...
    then(/^the SVG should have a width of (\d+) and a height of (\d+)$/, (width, height) => {
  ...
  test('Create an SVG with default dimensions', ({ given, when, then }) => {
    ...
    then(/^the SVG should have a default width of (\d+) and height of (\d+)$/, (defaultWidth, defaultHeight) => {
